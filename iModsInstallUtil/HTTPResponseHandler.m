...
+ (HTTPResponseHandler *)handlerForRequest:(CFHTTPMessageRef)aRequest
	...
	HTTPResponseHandler *handler = [[classForRequest alloc] initWithRequest:aRequest method:method url:requestURL headerFields:requestHeaderFields fileHandle:requestFileHandle server:aServer]
		;
